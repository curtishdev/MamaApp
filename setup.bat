...
set autohotkey_setup_url=https://www.autohotkey.com/download/1.1/AutoHotkey_1.1.36.01_setup.exe

if not exist "%autohotkey_exe%" (
    echo AutoHotkey не найден. Открываю страницу для скачивания...
    start chrome "%autohotkey_setup_url%"
    echo Установите данное приложение и выберите быструю установку, после чего запустите установщика.
